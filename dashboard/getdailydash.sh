...
singularity exec /share/Apps/virtualapps/rstudio/rstudio-r402-base.sif R -e "rmarkdown::render('dashboard.Rmd') ; rmarkdown::render('annualusage.Rmd') ; rmarkdown::render('summary.Rmd'); rmarkdown::render('training.Rmd'); source('public_dash.R')"
if [[ "$mday" -ge 2 ]] ; then
 scp -r dashboard.html dashboard.Rmd annualusage.html annualusage.Rmd webapps:/srv/projects/hpc/usage/ 
 scp -r dashboard.html dashboard.Rmd annualusage.html annualusage.Rmd webapps:/home/alp514/public_html/sol-metrics/
else
 scp -r dashboard.html dashboard.Rmd annualusage.html annualusage.Rmd webapps:/home/alp514/public_html/sol-metrics/
fi

scp -r sol_value.jpg webapps:/srv/projects/hpc/
scp -r annual_*html monthly*html total*html pidept*html user*html summary.html training.html cpu_gpu*.html *powerusage.html webapps:/srv/projects/hpc/public/
