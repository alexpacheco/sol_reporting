...
if [[ "$mday" -ge 2 ]] ; then
 scp -rp dashboard.html dashboard.Rmd annualusage.html annualusage.Rmd webapps:/srv/projects/hpc/usage/ 
 scp -rp dashboard.html dashboard.Rmd annualusage.html annualusage.Rmd webapps:/home/alp514/public_html/sol-metrics/
else
 scp -rp dashboard.html dashboard.Rmd annualusage.html annualusage.Rmd webapps:/home/alp514/public_html/sol-metrics/
fi

scp -rp sol_value.jpg webapps:/srv/projects/hpc/
scp -rp annual_*html monthly*html total*html pidept*html user*html summary.html training.html cpu_gpu*.html *powerusage.html webapps:/srv/projects/hpc/public/
